...
public class ClassPathScanningCandidateComponentProvider implements EnvironmentCapable, ResourceLoaderAware {
	...
	protected boolean isCandidateComponent(MetadataReader metadataReader) throws IOException {
		logger.info("ClassPathScanningCandidateComponentProvider isCandidateComponent(MetadataReader metadataReader) metadataReader = " + metadataReader);
		logger.info("ClassPathScanningCandidateComponentProvider isCandidateComponent(MetadataReader metadataReader) this.metadataReaderFactory = " + this.metadataReaderFactory);
		...
		for (TypeFilter tf : this.includeFilters) {
			if (tf.match(metadataReader, this.metadataReaderFactory)) {
				...
				logger.info("ClassPathScanningCandidateComponentProvider isCandidateComponent(MetadataReader metadataReader) metadata = " + metadata);
