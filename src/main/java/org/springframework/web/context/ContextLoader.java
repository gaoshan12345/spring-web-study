...
public class ContextLoader {
	...
	protected WebApplicationContext createWebApplicationContext(ServletContext sc) {
		...
		System.out.println("ContextLoader createWebApplicationContext contextClass = " + contextClass.getSimpleName());
	...
	protected void configureAndRefreshWebApplicationContext(ConfigurableWebApplicationContext wac, ServletContext sc) {
		...
		/**
		 * 启动容器的初始化，我们已经很熟悉的refresh调用
		 * 最终可能会调用到AbstractApplicationContext类的refresh方法
		 * 
		 * wac默认值是XmlWebApplicationContext
	...
	protected Class<?> determineContextClass(ServletContext servletContext) {
		//读取在servletContext中对CONTEXT_CLASS_PARAM参数的设置。public static final String CONTEXT_CLASS_PARAM = "contextClass";
		...
		if (contextClassName != null) {
			...
			//从配置文件ContextLoader.properties找到指定的contextClassName，org.springframework.web.context.WebApplicationContext=org.springframework.web.context.support.XmlWebApplicationContext
