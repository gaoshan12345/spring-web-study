...
public abstract class AbstractBeanDefinitionParser implements BeanDefinitionParser {
	...
	public final BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		logger.info("parse element.getNamespaceURI() = " + element.getNamespaceURI() +",DefinitionCount = " + parserContext.getRegistry().getBeanDefinitionCount());
		String[] tempNames = parserContext.getRegistry().getBeanDefinitionNames();
		for(String beanName : tempNames){
