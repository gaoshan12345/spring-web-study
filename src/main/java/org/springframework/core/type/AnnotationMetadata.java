...
public interface AnnotationMetadata extends ClassMetadata {
	...
	/**
	 * 	以AnnotationMetadataReadingVisitor类的hasAnnotation和hasMetaAnnotation方法实现为例，说明两个方法的差异
	 * 
	 * 	扫描包内的注解类
	 * 	@Controller
	 ...
	 *	}
	 *	备注this.annotationSet = [org.springframework.stereotype.Controller]
	 * 	备注annotationType = org.springframework.stereotype.Component
	 * 
	 * 
	 ...
	 *		return false;
	 *	}
	 *	备注Collection<Set<String>> allMetaTypes = this.metaAnnotationMap.values();
	 * 	备注allMetaTypes = [[java.lang.annotation.Target, java.lang.annotation.Documented, java.lang.annotation.Retention, org.springframework.stereotype.Component]]
	 * 
	 *
